          ...
          <Toolbar>
            ...
            <HashLink to="Etud_profile#favoris" className={classes.panier}>
              ...
              <IconButton style={{ marginBottom: "13px" }}>
               ...
               {user !== null && user.Role === "Conseiller"?
              <Link to="/Visioconférence">
                <IconButton style={{ marginBottom: "13px" }}>
                  <i style={{ color: "rgba(0, 0, 0, 0.80)" }} class="fas fa-play-circle"> </i>
                </IconButton>
              </Link>
              : <span></span> }
                ...
                <i style={{ color: "rgba(0, 0, 0, 0.80)" }} class="fas fa-comment-alt"><em> Forum discussion</em></i>
                </IconButton>
              </Link>
            </div>
          </Toolbar>
          ...
          <Slider {...settings}>
            ...
            {dataArticle.map((article , index)=>{
              ...
              return <div key={index} >
                ...
                <CardHeader
                  avatar={
                    <Avatar  className={classes.avatar}   src={article ? article.AuteurEtud !== null ? article.AuteurEtud.img !== null ? article.AuteurEtud.img :  "" :"" : ""} />
                  }
                  title={article ? article.AuteurEtud !== null ? article.AuteurEtud.Nom_prénom !== null ? article.AuteurEtud.Nom_prénom :  "" :"" : ""}
                  subheader={
                    article.createdAt
